...
- **SecureVault.Core.Tests** — xUnit-тесты (27 тестов): round-trip шифрования, обнаружение подмены/неверного пароля/файла-ключа, округление контейнера по бакетам, множественные сейфы, автоочистка буфера обмена.
